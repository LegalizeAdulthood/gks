...
typedef enum GFunction
{
    ...
    GFN_DEACTIVATE_WORKSTATION,
    GFN_ESCAPE,
    GFN_FILL_AREA,
    GFN_GDP,
    GFN_INQUIRE_CLIPPING,
    GFN_INQUIRE_COLOR_FACILITIES,
    GFN_INQUIRE_COLOR_REPRESENTATION,
    GFN_INQUIRE_DISPLAY_SPACE_SIZE,
    GFN_INQUIRE_FILL_AREA_FACILITIES,
    GFN_INQUIRE_LEVEL_OF_GKS,
    GFN_INQUIRE_LIST_OF_COLOR_INDICES,
    GFN_INQUIRE_MAXIMUM_LENGTH_OF_WORKSTATION_STATE_TABLES,
    GFN_INQUIRE_NORMALIZATION_TRANSFORMATION,
    GFN_INQUIRE_POLYLINE_FACILITIES,
    GFN_INQUIRE_POLYMARKER_FACILITIES,
    GFN_INQUIRE_TEXT_EXTENT,
    GFN_INQUIRE_TEXT_FACILITIES,
    GFN_INQUIRE_WORKSTATION_CONNECTION_AND_TYPE,
    GFN_INQUIRE_WORKSTATION_TRANSFORMATION,
    GFN_OPEN_GKS,
    GFN_OPEN_WORKSTATION,
    GFN_POLYLINE,
    GFN_POLYMARKER,
    GFN_SELECT_NORMALIZATION_TRANSFORMATION,
    GFN_SET_ASPECT_SOURCE_FLAGS,
    GFN_SET_CHARACTER_EXPANSION_FACTOR,
    GFN_SET_CHARACTER_HEIGHT,
    GFN_SET_CHARACTER_SPACING,
    GFN_SET_CHARACTER_UP_VECTOR,
    GFN_SET_CLIPPING_INDICATOR,
    GFN_SET_COLOR_REPRESENTATION,
    GFN_SET_FILL_AREA_COLOR_INDEX,
    GFN_SET_FILL_AREA_INTERIOR_STYLE,
    GFN_SET_LINETYPE,
    GFN_SET_MARKER_SIZE_SCALE_FACTOR,
    GFN_SET_MARKER_TYPE,
    GFN_SET_POLYLINE_COLOR_INDEX,
    GFN_SET_POLYLINE_INDEX,
    GFN_SET_POLYMARKER_COLOR_INDEX,
    GFN_SET_POLYMARKER_INDEX,
    GFN_SET_TEXT_ALIGNMENT,
    GFN_SET_TEXT_COLOR_INDEX,
    GFN_SET_TEXT_FONT_AND_PRECISION,
    GFN_SET_TEXT_INDEX,
    GFN_SET_VIEWPORT,
    GFN_SET_WINDOW,
    GFN_SET_WORKSTATION_VIEWPORT,
    GFN_SET_WORKSTATION_WINDOW,
    GFN_TEXT,
    GFN_UPDATE_WORKSTATION,
} GFunction;
